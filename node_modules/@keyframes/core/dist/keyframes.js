...
var clone = function(input) {
...
}, voidFunction = function() {}, objToCss = function(obj) {
    ...
    function Keyframes(elem) {
        ...
        this.mountedElement = elem, this.frozenStyles = [];
    }
    return Keyframes.isSupported = function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    return this.removeEvents(), this.mountedElement.style.animationPlayState = "running", 
        ...
        var _this = this;
        if (this.mountedElement.style.animationName === this.getAnimationName(animationOptions)) return this.freeze(), 
        requestAnimationFrame(function() {
        ...
        var _a = callbacks || {}, _b = _a.onBeforeStart, onBeforeStart = void 0 === _b ? null : _b, _c = _a.onStart, onStart = void 0 === _c ? null : _c, _d = _a.onIteration, onIteration = void 0 === _d ? null : _d, _e = _a.onEnd, onEnd = void 0 === _e ? null : _e, animationcss = Keyframes.playCSS(animationOptions);
        return onBeforeStart && onBeforeStart(), this.mountedElement.style.animationPlayState = "running", 
        this.mountedElement.style.animation = animationcss, onIteration && addEvent("animationiteration", onIteration), 
        onEnd && addEvent("animationend", onEnd), onStart && requestAnimationFrame(onStart), 
        this;
        ...
        return this.mountedElement.removeEventListener("animationiteration", this.animationiterationListener), 
        ...
        currentQueueLength || (this.callbacks.onBeforeStart && this.callbacks.onBeforeStart(), 
        this.playNext(), this.callbacks.onStart && requestAnimationFrame(this.callbacks.onStart)), 
        this;
