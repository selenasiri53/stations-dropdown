...
var wait = function () { return new Promise(function (accept) {
...
var Keyframes = (function () {
    ...
    Keyframes.prototype.play = function (animationOptions, callbacks) {
        ...
        var _a = callbacks || {}, _b = _a.onBeforeStart, onBeforeStart = _b === void 0 ? null : _b, _c = _a.onStart, onStart = _c === void 0 ? null : _c, _d = _a.onIteration, onIteration = _d === void 0 ? null : _d, _e = _a.onEnd, onEnd = _e === void 0 ? null : _e;
    ...
    Keyframes.prototype.loop = function (animationOptions, callbacks) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.resetQueue()];
                    case 1:
                        _a.sent();
    ...
    Keyframes.addToRuleCache = function (frameData) {
        if (!this.ruleCache[frameData.name]) {
            var rules = Object.values(frameData)
                ...
                .map(function (v) { return Object.keys(v); }).flat();
